...
<script type="text/javascript">
    ...
    function newUser() {
        ...
        $('#fm').form('clear');
        url = '${pageContext.request.contextPath}/user/addUpdate.action';
    }
    ...
    function editUser() {
        ...
        if (row) {
            ...
            $('#fm').form('load', row);
            url = '${pageContext.request.contextPath}/user/addUpdate.action?id=' + row.id;
        }
    }
        ...
        $('#fm').form('submit', {
            ...
            success: function (result) {
                ...
                if (result.flag) {
                    ...
                    $.messager.alert('信息', result.msg, "error", function () {
                    });
                }
            }
        });
    ...
    function destroyUser() {
        ...
        if (row) {
            $.messager.confirm('删除用户', '确定要删除该用户吗?', function (r) {
                if (r) {
                    $.get('${pageContext.request.contextPath}/user/del.action', {id: row.id}, function (result) {
                        if (result.flag) {
                            $.messager.alert('信息', result.msg, "info", function () {
                                $('#dg').datagrid('reload');    // reload the user data
                            });
...
<script type="text/javascript">
    $("#shuaxin").click(function () {
        ...
        $.get('${pageContext.request.contextPath}/user/sex.action').done(function (datas) {
            var options = {
                title: {
                    text: '性别',
                    subtext: '性别统计',
